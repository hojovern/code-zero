...
4. Performance:
   ...
   - Unsubscribe from unused channels</code></pre>
		...
		<nav class="lesson-nav">
			<a href="/student-portal/{username}/full-stack-web-development/week-2" class="nav-prev">
				<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
					<path d="M19 12H5M12 19l-7-7 7-7"/>
				</svg>
				Week 2 Overview
			</a>
			<a href="/student-portal/{username}/full-stack-web-development/week-2/day-7" class="nav-next">
