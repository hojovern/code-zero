...
<div class="dashboard-layout">
	...
	<aside class="sidebar">
		...
		<nav class="sidebar-nav">
			<a href="/student-portal/{username}" class="nav-item" class:active={isActive(`/student-portal/${username}`)}>
				<span class="nav-icon">📊</span>
				Student Portal
			</a>
			<a href="/student-portal/{username}/my-courses" class="nav-item" class:active={page.url.pathname.startsWith(`/student-portal/${username}/my-courses`)}>
				<span class="nav-icon">📚</span>
				My Courses
			</a>
			<a href="/student-portal/{username}/settings" class="nav-item" class:active={isActive(`/student-portal/${username}/settings`)}>
			...
			<div class="admin-bar">
				<div class="admin-bar-content">
					...
					<span class="admin-bar-text">
						Viewing as <strong>{data.user.name || data.user.username}</strong>
					</span>
				</div>
				<div class="admin-bar-actions">
					<a href="/admin/students/{data.user.username}" class="admin-btn">
						⚙️ Manage Student
					</a>
					<a href="/student-portal/{data.currentUser.username}" class="admin-btn admin-btn-secondary">
						← Back to My Portal
					</a>
				</div>
			</div>
