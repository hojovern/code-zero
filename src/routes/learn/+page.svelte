...
<svelte:head>
	...
	<meta name="description" content="Access your Ship Sprint curriculum. Day-by-day lessons to build and ship your product with AI." />
...
<section class="portal-hero">
	<div class="container">
		...
		<h1 class="portal-title">Ship Sprint Curriculum</h1>
		...
		<div class="weeks-list">
			{#each weeks as week}
				{#if week.status === 'available'}
					<a href="/learn/week-{week.week}" class="week-block available">
